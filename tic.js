...
function displayCongrats(){
	let congrats = document.getElementsByClassName("congragulateGif")[0];
	congrats.style.display = 'block';
	// congrats.classList.toggle('congragulateGif');
}

function displayMatchTie(){
	let congrats = document.getElementById("matchTieGif");
	congrats.style.display = 'block';
	// congrats.classList.toggle('congragulateGif');
}

function winnerSongPlay(){
	const clickSound = new Audio('./Assets/333404__jayfrosting__cheer-2.wav');
...
function matchTieSong(){
	const clickSound = new Audio('./Assets/523365__matrixxx__bomb-explosion.wav');
	clickSound.currentTime = 0; // Reset sound to the beginning
	clickSound.play(); // Play the sound
}
function onClickSong(){
	const clickSound = new Audio('./Assets/626941__maikkihapsis__pilvi.wav');
    clickSound.currentTime = 0; // Reset sound to the beginning
    clickSound.play(); // Play the sound
}
...
// document.addEventListener('mouseover', initialSongPlay);